         ...
         it('Should write to csv file', function() {
            ...
            cy.request('https://www.bettercloud.com/company/#board')
                .then((Response) => {
                    ...
                    var csvFileData = [
                        ['JON HALLET', 'Jon Hallett is the Executive Chairman of BetterCloud. Jon’s investment firm, Hallett Capital, led BetterClouds first round of company funding. '],
